...
const InfiniteScroll = class {
  ...
  connectedCallback() {
    ...
    return (0,D_INGENIER_A_WEB_TFM_0_Codigo_healthtracker_mobile_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const contentEl = (0,_index_52e04ddf_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this.el);

      if (!contentEl) {
        (0,_index_52e04ddf_js__WEBPACK_IMPORTED_MODULE_2__.p)(_this.el);
        return;
      }

      _this.scrollEl = yield (0,_index_52e04ddf_js__WEBPACK_IMPORTED_MODULE_2__.g)(contentEl);
...
const InfiniteScrollContent = class {
  ...
  componentDidLoad() {
    if (this.loadingSpinner === undefined) {
      const mode = (0,_ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_3__.b)(this);
      this.loadingSpinner = _ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_3__.c.get('infiniteLoadingSpinner', _ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_3__.c.get('spinner', mode === 'ios' ? 'lines' : 'crescent'));
    }
  }
